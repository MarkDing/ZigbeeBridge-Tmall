...
#define HAL_USART3_RX_QUEUE_SIZE              (128UL)
#define HAL_USART3_BAUD_RATE                  (115200UL)
#define HAL_USART3_RXSTOP                     (16UL)
#define HAL_USART3_RXSTART                    (16UL)
#define HAL_USART3_TX_QUEUE_SIZE              (128UL)
#define HAL_USART3_FLOW_CONTROL               (HAL_USART_FLOW_CONTROL_NONE)
// [USART3]$
